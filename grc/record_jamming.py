...
# Title: Record Jamming
# Generated: Sun Jan 29 20:42:56 2017
##################################################
...
class record_jamming(grc_wxgui.top_block_gui):
    ...
    def __init__(self, outfile=""):
        ...
        self.high_pass_filter_0 = filter.fir_filter_ccf(1, firdes.high_pass(
        	1, samp_rate, 220e3, 5e3, firdes.WIN_HANN, 6.76))
        ...
        self.connect((self.high_pass_filter_0, 0), (self.blocks_file_sink_0, 0))    
        self.connect((self.high_pass_filter_0, 0), (self.wxgui_fftsink2_0, 0))    
        self.connect((self.high_pass_filter_0, 0), (self.wxgui_waterfallsink2_0, 0))    
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.high_pass_filter_0.set_taps(firdes.high_pass(1, self.samp_rate, 220e3, 5e3, firdes.WIN_HANN, 6.76))
...
def main(top_block_cls=record_jamming, options=None):
    if options is None:
        options, _ = argument_parser().parse_args()

    tb = top_block_cls(outfile=options.outfile)
    tb.Start(True)
    tb.Wait()
